...
* All demos should be self-contained in their own directory
* Every directory must have a `README.md` with an overview of the demo scenario and instructions for users to deploy the demo themselves.
* All demos must have an automated deployment component such as Docker Compose, Terraform, or Cloud Formation to name a few.
